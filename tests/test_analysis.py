...
from whoosh_update import analysis, fields, qparser
from whoosh_update.compat import b, u, unichr
from whoosh_update.compat import dumps
...
def test_unicode_blocks():
    from whoosh_update.support.unicode import blocks, blockname, blocknum
...
def test_porter2():
    from whoosh_update.lang.porter2 import stem
...
def test_url():
    sample = u("Visit http://bitbucket.org/mchaput/whoosh_update or " +
    ...
    for ana in anas:
        ...
        assert ts == [u('visit'), u('http://bitbucket.org/mchaput/whoosh_update'),
...
def test_start_pos():
    from whoosh_update import formats
...
def test_frowny_face():
    # See https://bitbucket.org/mchaput/whoosh_update/issue/166/
...
def test_charset_pickeability():
    from whoosh_update.support import charset
