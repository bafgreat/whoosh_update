...
import pytest
from whoosh_update import fields, formats, reading

from whoosh_update.compat import b, u, xrange
...
def test_reader_subclasses():
    from whoosh_update.util.testing import check_abstract_methods
