...
from whoosh_update import fields, query
from whoosh_update.compat import u, izip, xrange, permutations, text_type
...
def test_basic_serial():
    check_multi()
    from whoosh_update.multiproc import SerialMpWriter
